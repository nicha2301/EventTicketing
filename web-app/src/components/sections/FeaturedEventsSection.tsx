...
export default function FeaturedEventsSection({ activeCategory }: Props) {
  ...
  return (
    <section id="events" className="py-12 sm:py-16 bg-gradient-to-b from-gray-50 to-white">
        ...
        {isLoading ? (
          <div className="flex justify-center py-12">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-gray-600 font-medium">Đang tải sự kiện nổi bật...</p>
            </div>
          </div>
        ) : (
              ...
              <div className="col-span-full text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    {isError ? "Không thể tải sự kiện" : "Chưa có sự kiện nổi bật"}
                  </h3>
